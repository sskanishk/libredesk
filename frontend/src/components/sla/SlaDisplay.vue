<template>
    <div v-if="dueAt">
        <span v-if="actualAt && isAfterDueTime"
            class="bg-red-100 p-1 rounded-xl text-xs text-red-700 border border-red-300">
        ...
        <span v-else-if="sla?.status === 'remaining'"
            class="bg-yellow-100 p-1 rounded-xl text-xs text-yellow-700 border border-yellow-300">
